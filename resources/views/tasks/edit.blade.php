                    ...
                    <form action="{{ route('tasks.update', $task->id) }}" method="POST" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Nhập mô tả chi tiết..."
                                class="form-control @error('description') is-invalid @enderror">{{ $task->description }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="due_date" id="due_date" type="date" value="{{ $task->due_date }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                                <option value="0" @if ($task->status == 0) selected @endif>Chưa bắt đầu
                                </option>
